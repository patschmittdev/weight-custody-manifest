...
by `tpm2_pcrextend 23:sha256=<serving-image-digest>` (both from the `tpm2-tools`
package), then immediately requests the AK-signed quote. Missing tools, an invalid measurement, or either TPM command
